...
from xiaoze_conversation_app.camera_worker import CameraWorker
from xiaoze_conversation_app.vision.head_tracking import HeadTracker


if TYPE_CHECKING:
    from xiaoze_conversation_app.vision.local_vision import VisionProcessor
...
def initialize_camera_and_vision(
    ...
    if not args.no_camera:
        if args.head_tracker is not None:
            try:
                if args.head_tracker == "yolo":
                    from xiaoze_conversation_app.vision.head_tracking.yolo_process import (
                    ...
                    from xiaoze_conversation_app.vision.head_tracking.mediapipe import (
        ...
        if args.local_vision:
            ...
            try:
                from xiaoze_conversation_app.vision.local_vision import initialize_vision_processor
