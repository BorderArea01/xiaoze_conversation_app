...
def _reload_core_tools() -> ModuleType:
    ...
    for module_name in list(sys.modules):
        if module_name.startswith("xiaoze_conversation_app.tools."):
    ...
    sys.modules.pop("xiaoze_conversation_app.tools.core_tools", None)
    core_tools_mod = importlib.import_module("xiaoze_conversation_app.tools.core_tools")
