...
from xiaoze_conversation_app.vision.head_tracking.yolo_process import YoloHeadTrackerProcess
...
def _patch_fake_worker(
    ...
    monkeypatch.setattr(
        "xiaoze_conversation_app.vision.head_tracking.yolo_process.subprocess.Popen",
        _spawn_fake_worker,
    )
